...
Generado: **2026-09-14** · assets con costo acumulado: **58 creditos** (~USD 1.68 a $0,029/cr).
...
| Clave | Que es | Modelo | Cr | Usado en | Ruta |
|---|---|---|---|---|---|
| `daily_fed` | THE MONEY · el dial de tasas y el barril que se derrama sobre el | flux-2-pro | 1 | DAILY/2026-09-14 | `produccion/hero/daily_fed.json` |
| `daily_hormuz` | THE MIDDLE EAST · el estrecho, la cola de barcos y el que no pasa | flux-2-pro | 1 | DAILY/2026-09-14 | `produccion/hero/daily_hormuz.json` |
...
| `mapabk` | — | 0 cr (Natural Earth + codigo) | 0 | — | `videos/06_ia_economia_politica/arte/assets` |
| `mapa07` | — | 0 cr (Natural Earth + codigo) | 0 | — | `videos/07_petroleo_ormuz/arte/assets` |
| `mapa08` | — | 0 cr (Natural Earth + codigo) | 0 | — | `videos/08_reino_unido/arte/assets` |
