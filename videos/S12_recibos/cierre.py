...
CIERRES = {
 ...
 2: ("[warm, quick] Part three is up now. Hit like and follow along.",
     'LIKE  +  SUBSCRIBE', 'PART 3 IS UP NOW'),
 3: ("[warm, quick] Part four is up now. Subscribe before you go.",
     'LIKE  +  SUBSCRIBE', 'PART 4 IS UP NOW'),
 4: ("[warm, quick] Subscribe, and follow the paper.",
     'LIKE  +  SUBSCRIBE', 'THAT WAS PART 4 OF 4'),   # el pie de la tarjeta ya dice FOLLOW THE PAPER
}
